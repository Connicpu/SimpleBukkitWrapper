...
namespace SBW2
{
    public partial class ShuttingDownServerBox : Form
    {
        public ShuttingDownServerBox()
        {
            InitializeComponent();
        }

        private void ShuttingDownServerBox_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
        }
    }
